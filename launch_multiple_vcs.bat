...
START /B .\build\quake3_debug\ioquake3.x86.exe +set r_fullscreen 0 +set sv_pure 0 +set vm_ui 0 +set vm_game 0 +set vm_cgame 0 +set fs_basepath %basepath% +set virtualClient 2 +set virtualClientSkill %skill% +set virtualClientBot %name% +set virtualClientName %clientNamePrefix%%loopCounter% +connect 127.0.0.1 >nul 2>nul
